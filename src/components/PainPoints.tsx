      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {painPoints.map((point, index) => (
            <div 
              key={index}
              className="bg-background p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4 border-warm-gold-500"
            >
              <div className="text-4xl mb-4">{point.icon}</div>
              <h3 className="text-2xl font-serif font-semibold text-deep-purple-600 mb-3">
                {point.title}
              </h3>
        ...
        <div className="mt-16 text-center">
          <p className="text-xl font-medium text-emerald-700 max-w-3xl mx-auto">
            &#34;And We have certainly made the Quran easy for remembrance, so is there any who will remember?&#34;
            <span className="block mt-2 text-lg text-foreground/80">— Surah Al-Qamar 54:17</span>
          </p>
        </div>
      </div>

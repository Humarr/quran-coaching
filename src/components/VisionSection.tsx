        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <div className="aspect-w-16 aspect-h-9 bg-emerald-100">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-[url('/images/quran-learning.jpg')] bg-cover bg-center">
                  <div className="absolute inset-0 bg-deep-purple-700/40"></div>
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-xl text-foreground/90 mb-8">
              Imagine opening the Quran and feeling <span className="font-semibold text-emerald-600">confidence</span> instead of hesitation. 
              Our method transforms your relationship with the Quran through:
            </p>
            
            <ul className="space-y-4">
              <li className="flex items-start">
                <div className="flex-shrink-0 mt-1 mr-4 text-emerald-600">
